...
public class SubscriptionsRecyclerViewAdapter extends RecyclerView.Adapter<SubscriptionsRecyclerViewAdapter.ViewHolder> {
    ...
    public SubscriptionsRecyclerViewAdapter(ArrayList<String> prices, ArrayList<String> dates,
    ...
    @NonNull
    @Override
    public SubscriptionsRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.subscriptions_list, parent,
                false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SubscriptionsRecyclerViewAdapter.ViewHolder holder, int position) {
